...
![Главный экран audio2text studio в режиме Whisper GPU](docs/screenshots/whisper-ui.png)

### GigaAM-v3 RNNT + CTC

![Выбор высокоточного режима GigaAM-v3 RNNT + CTC](docs/screenshots/gigaam-ui.png)
